...
def slider():
    ua = " " if random.random() < 0.5 else "TW96aWxsYS81LjAgKExpbnV4OyBBbmRyb2lkIDYuMDsgTmV4dXMgNSBCdWlsZC9NUkE1OE4pIEFwcGxlV2ViS2l0LzUzNy4zNiAoS0hUTUwsIGxpa2UgR2Vja28pIENocm9tZS8xMjQuMC4wLjAgTW9iaWxlIFNhZmFyaS81MzcuMzY="
    cookies = {
        'PHPSESSID': PHPSESSID,
    }
    headers = {
    ...
    opinion.add_argument(
        ...
        "Safari/537.36 NetType/WIFI MicroMessenger/7.0.20.1781(0x6700143B) WindowsWechat(0x6309092b) XWEB/9079 Flue")

    opinion.add_argument("cookie=PHPSESSID=" + PHPSESSID)
    # opinion.add_argument("--headless")
